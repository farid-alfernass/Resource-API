# Resource-API
Library for requests using Guzzle

What You Need Install Guzzle
...
$apiCounter = 'http://api.domain.com/v1/counters/store';
$this->resourceapi->setParams($params);
$test = $this->resourceapi->createRequest('POST',$apiCounter);
